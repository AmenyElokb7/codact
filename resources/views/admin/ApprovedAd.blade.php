                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Approved Ads</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            @if ($approvedAds->isEmpty())
                                <p>No Approved ads at the moment.</p>
                            @else
                                <table id=>
                                        ...
                                        <tbody>
                                            @foreach ($approvedAds as $ad)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if($ad->status == 'paused' && $formattedDate <= $ad->enddate)
                                                            <a href="{{ route('resume-ad', $ad->id) }}"><i class="fas fa-play"></i> Resume</a>
                                                        @elseif ($ad->status == 'approved' && $formattedDate <= $ad->enddate)
                                                            <a href="{{ route('pause-ad', $ad->id) }}"><i class="fas fa-pause"></i> Pause</a>
                                                        @endif
                                                    </td>
                                                </tr>
                                            @endforeach
